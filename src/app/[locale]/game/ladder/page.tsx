import Ladder from "@/components/template/game/ladder";
...
export async function generateMetadata({ params, searchParams }: TypeMetaProps, parent: ResolvingMetadata): Promise<Metadata> {
  return {
    title: `LSW-APP-Ladder`,
    description: `LSW-APP-Ladder`,
    openGraph: {
      title: `LSW-APP-Ladder`,
      description: `LSW-APP-Ladder`,
      type: "article",
...
export default async function LadderLayout({ params, searchParams }: { params: any; searchParams: any }) {
  return (
