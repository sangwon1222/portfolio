...
export default class BunsTray{
    ...
    async init(){
        // this.mTray = new Tray(this.mScene,this.mPosition.x,this.mPosition.y,0, this.mIsBun)
        this.mTrayList = [
...
export class Tray {
    ...
    fail(){
        gsap.to(this.mImage,{x: this.mDragStartX,y: this.mDragStartY,duration:0.25,onComplete:()=>{
